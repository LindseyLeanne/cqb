    ...
    ?>
        <div class="container no-padding">
            ...
            <ul class="socials-icons">
                ...
                ?>
                <a href="<?php echo $global_theme_options[$option_idx]; ?>" target="_blank"><li class="<?php echo $key; ?>" ><!--<img src="<?php  /* echo get_template_directory_uri()."/images/social_icons/" . $value . ".png"; ?>" alt="<?php echo $key; */ ?>" />--></li></a>
                <?php
                    }
                }
                ?>
